...
const chartData = {
  ...
  datasets: [
    {
      label: 'Marketing ROI',
      data: [85, 120, 110, 150, 130, 170, 200, 180, 160, 170, 190, 210],
    ...
    },
    {
      ...
      data: [70, 90, 80, 120, 100, 140, 170, 150, 130, 140, 160, 180],
...
export default function MarketingAnalytics() {
  ...
  const faqList = [
    {
      question: 'Why Choose Express Analytics for Marketing Analytics?',
      answer: 'We offer comprehensive marketing analytics solutions that help businesses optimize their marketing spend, improve campaign performance, and drive better ROI. Our advanced analytics capabilities include predictive modeling, attribution analysis, and real-time performance monitoring to ensure your marketing efforts deliver maximum impact.'
    },
    {
      question: 'What is marketing analytics and why is it important?',
      answer: 'Marketing analytics is the practice of measuring, managing, and analyzing marketing performance to maximize effectiveness and optimize return on investment. It is important because it provides data-driven insights to make informed marketing decisions, optimize campaigns, and improve overall business performance.'
    },
    {
      question: 'How does Express Analytics help improve marketing ROI?',
      answer: 'Express Analytics uses advanced data analysis and machine learning to identify the most effective marketing channels, optimize campaign performance, and allocate budget more efficiently. By providing actionable insights and predictive analytics, we help businesses maximize their marketing return on investment.'
    },
    {
      question: 'What types of businesses benefit from marketing analytics?',
      answer: 'Any business that invests in marketing can benefit from marketing analytics, including e-commerce, retail, B2B companies, and service providers. Our solutions are designed for marketing teams, CMOs, and business leaders looking to optimize campaigns, improve performance, and drive growth.'
    },
  ];
      ...
      <main className="flex-1">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center w-full pt-12 pb-80 md:pb-[400px]">
            ...
            >
              Optimize Campaigns & Maximize ROI
            </span>
            <h1
            ...
            <p className="max-w-2xl mx-auto mb-6 text-base md:text-lg text-center text-gray-700 font-medium fade-up-3">
              Use Express Analytics' proven AI solutions to optimize your marketing campaigns and maximize ROI. We provide strategic marketing analytics consulting along with experienced resources to implement complete data analytics solutions.
            </p>
            <button
        ...
        {/* Marketing Analytics Solutions Include Section */}
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto rounded-3xl overflow-hidden" style={{ background: 'linear-gradient(120deg, #DC1B36 0%, #9B51E0 100%)' }}>
            <div className="py-16 px-4 md:px-16 flex flex-col items-center">
              <h3 className="text-4xl font-semibold text-center mb-4 text-white">Marketing analytics solutions include</h3>
              <p className="max-w-2xl mx-auto text-lg md:text-xl text-white font-medium mb-12 text-center opacity-90">
                Optimize campaigns, predict performance, and maximize ROI with Express Analytics' marketing analytics solutions built for CMOs and business leaders.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full">
                ...
                <div className="flex flex-col items-center text-center">
                  <span className="mb-4">
                    <img src="/Performance-Optimization.webp" alt="Performance Monitoring icon" className="w-16 h-16 object-contain rounded-xl shadow-lg" />
                  </span>
                  <h4 className="text-xl font-bold mb-2 text-white">Performance Monitoring</h4>
                  <p className="text-white opacity-90">Real-time monitoring of campaign performance with automated alerts and insights for quick optimization.</p>
                </div>
                {/* ROI Optimization */}
                <div className="flex flex-col items-center text-center">
                  <span className="mb-4">
                    <img src="/ROI.webp" alt="ROI Optimization icon" className="w-16 h-16 object-contain rounded-xl shadow-lg" />
                  </span>
                  <h4 className="text-xl font-bold mb-2 text-white">ROI Optimization</h4>
                  <p className="text-white opacity-90">Maximize return on marketing investment through data-driven insights and strategic optimization.</p>
                </div>
                {/* Audience Insights */}
                <div className="flex flex-col items-center text-center">
                  <span className="mb-4">
                    <img src="/Customer-Segmentation-Analysis.webp" alt="Audience Insights icon" className="w-16 h-16 object-contain rounded-xl shadow-lg" />
                  </span>
                  <h4 className="text-xl font-bold mb-2 text-white">Audience Insights</h4>
                  <p className="text-white opacity-90">Deep understanding of your target audience to create more effective and personalized marketing campaigns.</p>
                </div>
                {/* Predictive Modeling */}
                <div className="flex flex-col items-center text-center">
                  <span className="mb-4">
                    <img src="/Predictive-Power.webp" alt="Predictive Modeling icon" className="w-16 h-16 object-contain rounded-xl shadow-lg" />
                  </span>
                  <h4 className="text-xl font-bold mb-2 text-white">Predictive Modeling</h4>
                  <p className="text-white opacity-90">Forecast future marketing performance and customer behavior to make proactive strategic decisions.</p>
                </div>
                {/* A/B Testing */}
                <div className="flex flex-col items-center text-center">
                  <span className="mb-4">
                    <img src="/Custom-Rules-AB-Testing.webp" alt="A/B Testing icon" className="w-16 h-16 object-contain rounded-xl shadow-lg" />
                  </span>
                  <h4 className="text-xl font-bold mb-2 text-white">A/B Testing</h4>
                  <p className="text-white opacity-90">Systematic testing of marketing variations to identify the most effective strategies and optimize performance.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto rounded-3xl overflow-hidden" style={{ background: 'linear-gradient(120deg, #DC1B36 0%, #9B51E0 100%)' }}>
            <div className="py-16 px-4 md:px-16 flex flex-col items-center">
              <h3 className="text-3xl md:text-4xl font-semibold text-center mb-12 text-white">Marketing Performance Analytics</h3>
              <div className="w-full max-w-4xl rounded-3xl shadow-2xl overflow-hidden relative mt-8" style={{ background: 'linear-gradient(120deg, #f3e6fa 0%, #fff 100%)', border: '1px solid #e5e7eb', zIndex: 2 }}>
                <div className="p-6">
                  <div className="absolute top-0 left-0 w-full px-6 py-4 flex items-center gap-3 text-gray-800 text-lg font-semibold" style={{ background: 'rgba(255,255,255,0.85)', borderTopLeftRadius: '1.5rem', borderTopRightRadius: '1.5rem' }}>
                    ...
                    Marketing Performance by Channel (2022-2025)
                  </div>
                  <Bar
                    data={chartData}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mt-12">
                <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center">
                  <h4 className="text-xl font-bold mb-2 text-gradient-main">Campaign Attribution</h4>
                  <p className="text-gray-700 mb-2">Understand which marketing channels contribute most to conversions and optimize budget allocation.</p>
                </div>
                <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center">
                  <h4 className="text-xl font-bold mb-2 text-gradient-main">Performance Tracking</h4>
                  <p className="text-gray-700 mb-2">Monitor campaign performance in real-time with automated alerts and insights.</p>
                </div>
                <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center">
                  <h4 className="text-xl font-bold mb-2 text-gradient-main">ROI Optimization</h4>
                  <p className="text-gray-700 mb-2">Maximize return on marketing investment through data-driven insights and strategic optimization.</p>
                </div>
                <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center">
                  <h4 className="text-xl font-bold mb-2 text-gradient-main">Audience Targeting</h4>
                  <p className="text-gray-700 mb-2">Identify and target the most valuable customer segments for maximum campaign effectiveness.</p>
                </div>
                <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center">
                  <h4 className="text-xl font-bold mb-2 text-gradient-main">Predictive Analytics</h4>
                  <p className="text-gray-700 mb-2">Forecast future marketing performance and customer behavior for proactive decision-making.</p>
                </div>
                <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center">
                  <h4 className="text-xl font-bold mb-2 text-gradient-main">A/B Testing</h4>
                  <p className="text-gray-700 mb-2">Systematically test marketing variations to identify the most effective strategies.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Who Needs Marketing Analytics Section */}
        <section className="py-16 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            <h3 className="text-3xl md:text-4xl font-semibold text-center mb-8" style={{ background: 'linear-gradient(90deg, #DC1B36, #9B51E0)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', textFillColor: 'transparent' }}>Who needs marketing analytics?</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center">
                <h4 className="text-xl font-bold mb-2 text-gradient-main">Marketing Teams</h4>
                <p className="text-gray-700 mb-2">Optimize campaigns, improve targeting, and maximize ROI with data-driven insights and performance analytics.</p>
              </div>
              <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center">
                <h4 className="text-xl font-bold mb-2 text-gradient-main">CMOs & Business Leaders</h4>
                <p className="text-gray-700 mb-2">Make informed strategic decisions based on comprehensive marketing performance data and predictive analytics.</p>
              </div>
              <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center">
                <h4 className="text-xl font-bold mb-2 text-gradient-main">Digital Marketing Agencies</h4>
                <p className="text-gray-700 mb-2">Provide clients with advanced analytics capabilities and demonstrate campaign effectiveness with detailed reporting.</p>
              </div>
              <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center">
                <h4 className="text-xl font-bold mb-2 text-gradient-main">E-commerce Businesses</h4>
                <p className="text-gray-700 mb-2">Optimize marketing spend, improve conversion rates, and increase customer lifetime value through data-driven insights.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex flex-col gap-8 items-stretch">
              <div className="bg-gray-800 rounded-2xl shadow-xl p-8 text-white flex flex-col gap-4 mb-4">
                <h4 className="text-2xl font-semibold mb-2" style={{ background: 'linear-gradient(90deg, #DC1B36, #9B51E0)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', textFillColor: 'transparent' }}>Who Can Benefit from Marketing Analytics?</h4>
                <ul className="list-disc list-inside text-base text-white/90">
                  <li>Marketing Teams: Optimize campaigns, improve targeting, and maximize ROI with data-driven insights.</li>
                  <li>CMOs & Business Leaders: Make informed strategic decisions based on comprehensive performance data.</li>
                  <li>Digital Marketing Agencies: Provide clients with advanced analytics capabilities and detailed reporting.</li>
                  <li>E-commerce Businesses: Optimize marketing spend and improve conversion rates through data-driven insights.</li>
                  <li>B2B Companies: Improve lead generation and sales pipeline performance with targeted analytics.</li>
                </ul>
                <div className="mt-4 text-pink-300 font-semibold text-center">Ready to Optimize Your Marketing? → Book a Free Demo of Our Marketing Analytics Platform</div>
              </div>
