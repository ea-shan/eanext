...
const analysisTypes = [
  {
    ...
    subtitle: 'Monitor brand perception across platforms',
    desc: 'Track customer sentiment on social media platforms to understand brand perception and identify potential issues early.',
    image: '/Sentiment-Analysis-1.webp',
  },
  {
    title: 'Customer Review Analysis',
    subtitle: 'Extract insights from customer feedback',
    desc: 'Analyze customer reviews and ratings to understand satisfaction levels and identify areas for improvement.',
    image: '/Sentiment-Analysis-1.webp',
  },
  {
    title: 'Email Sentiment Analysis',
    subtitle: 'Understand customer communication tone',
    desc: 'Analyze email communications to gauge customer satisfaction and identify potential churn signals.',
    image: '/Sentiment-Analysis-1.webp',
  },
  {
    title: 'Survey Response Analysis',
    subtitle: 'Process structured feedback data',
    desc: 'Extract sentiment from survey responses to understand customer satisfaction and identify trends.',
    image: '/Sentiment-Analysis-1.webp',
  },
  {
    title: 'Call Center Sentiment Analysis',
    subtitle: 'Monitor customer service interactions',
    desc: 'Analyze call center interactions to improve customer service quality and identify training opportunities.',
    image: '/Sentiment-Analysis-1.webp',
  },
  {
    title: 'Product Feedback Analysis',
    subtitle: 'Understand product perception',
    desc: 'Analyze product-related feedback to understand customer satisfaction and guide product development.',
    image: '/Sentiment-Analysis-1.webp',
  },
];

const benefits = [
  'Real-time Monitoring: Track customer sentiment in real-time to respond quickly to issues and opportunities.',
  'Improved Customer Experience: Identify pain points and areas for improvement to enhance customer satisfaction.',
  'Brand Protection: Detect negative sentiment early to prevent potential PR crises and protect brand reputation.',
  'Data-Driven Decisions: Make informed decisions based on actual customer sentiment rather than assumptions.',
  'Competitive Advantage: Understand how your brand sentiment compares to competitors in the market.',
  'Proactive Customer Service: Identify and address customer issues before they escalate to complaints.',
];

const processSteps = [
  {
    title: 'Data Collection',
    desc: 'Gather customer feedback from various sources including social media, reviews, surveys, and support interactions.',
  },
  {
    title: 'Text Preprocessing',
    desc: 'Clean and prepare text data for analysis by removing noise, standardizing formats, and handling special characters.',
  },
  {
    title: 'Sentiment Classification',
    desc: 'Use advanced NLP and machine learning models to classify sentiment as positive, negative, or neutral.',
  },
  {
    title: 'Insight Generation',
    desc: 'Generate actionable insights and recommendations based on sentiment analysis results.',
  },
];
    ...
    <div className="bg-white text-gray-900 flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        >
          <div className="max-w-4xl w-full mx-auto flex flex-col items-center text-center py-12 md:py-20">
            <h1 className="text-3xl md:text-5xl font-extrabold mb-4 leading-tight" style={{ background: 'linear-gradient(90deg, #DC1B36, #9B51E0)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', textFillColor: 'transparent' }}>
              Understand Customer Emotions | Sentiment Analysis Services
            </h1>
            <p className="text-lg md:text-2xl text-gray-700 font-medium mb-6 max-w-2xl mx-auto">
              Drive Customer Engagement with AI-Powered Sentiment Analysis<br />
              Express Analytics helps you understand customer emotions and feedback to improve satisfaction and loyalty.
            </p>
            ...
            <div className="w-full flex justify-center">
              <img
                src="/Sentiment-Analysis-1.webp"
                alt="Sentiment Analysis Hero"
        ...
        <section className="py-16 px-4 text-center bg-white">
          <h3 className="text-3xl md:text-4xl font-semibold mb-4" style={{ background: 'linear-gradient(90deg, #DC1B36, #9B51E0)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', textFillColor: 'transparent' }}>Sentiment Analysis Services</h3>
          <h4 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-900">How Express Analytics helps with Sentiment Analysis?</h4>
          <div className="max-w-3xl mx-auto text-lg md:text-2xl text-gray-700 font-medium mb-8">
            Our advanced sentiment analysis services use natural language processing and machine learning to understand customer emotions and feedback. This helps you –
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12">
            <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center border-t-4 border-pink-500">
              <img src="/Improving-personalization-and-campaign-effectiveness.webp" alt="Monitoring Icon" className="w-14 h-14 object-contain rounded-xl shadow mb-4" />
              <h5 className="text-xl font-bold mb-2 text-gradient-main">Monitor customer sentiment in real-time</h5>
              <p className="text-gray-700">Track how customers feel about your brand, products, and services across all touchpoints.</p>
            </div>
            <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center border-t-4 border-purple-500">
              <img src="/Identifying-niche-markets.webp" alt="Insights Icon" className="w-14 h-14 object-contain rounded-xl shadow mb-4" />
              <h5 className="text-xl font-bold mb-2 text-gradient-main">Extract actionable insights</h5>
              <p className="text-gray-700">Identify trends, patterns, and specific issues that need attention to improve customer experience.</p>
            </div>
            <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center text-center border-t-4 border-blue-500">
              <img src="/Understanding-where-customers-are-in-their-journey.webp" alt="Improvement Icon" className="w-14 h-14 object-contain rounded-xl shadow mb-4" />
              <h5 className="text-xl font-bold mb-2 text-gradient-main">Improve customer satisfaction</h5>
              <p className="text-gray-700">Address customer concerns proactively and enhance products and services based on feedback.</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 bg-gray-50">
          <h3 className="text-3xl md:text-4xl font-semibold text-center mb-16" style={{ background: 'linear-gradient(90deg, #DC1B36, #9B51E0)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', textFillColor: 'transparent' }}>Our Sentiment Analysis Services</h3>
          ...
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div className="flex flex-col gap-8 items-stretch">
              <div className="bg-gray-800 rounded-2xl shadow-xl p-8 text-white flex flex-col gap-4 mb-4">
                <h4 className="text-2xl font-semibold mb-2" style={{ background: 'linear-gradient(90deg, #DC1B36, #9B51E0)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', textFillColor: 'transparent' }}>Who Benefits from Sentiment Analysis?</h4>
                <ul className="list-disc list-inside text-base text-white/90">
                  <li>Customer service teams wanting to improve response quality.</li>
                  <li>Marketing teams looking to understand brand perception.</li>
                  <li>Product teams seeking feedback for improvement.</li>
                </ul>
